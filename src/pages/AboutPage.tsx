...
const TABS_INDEX = [
  ...
  { tab: 'Transportation',   domains: 'Transit ridership, road/bridge condition, FasTrak tolling, CT DOT capital projects, Vision Zero safety' },
  { tab: 'Courts',           domains: 'Caseload by type, Tyler Odyssey e-filing adoption curve, processing time SLAs, district performance' },
  { tab: 'Social Services',  domains: 'HUSKY/Medicaid enrollment, SNAP trend, DCF child welfare caseload, program cost portfolio, federal match rates' },
